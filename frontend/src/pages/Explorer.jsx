...
export default function Explorer() {
  ...
  return (
    <div className="page-shell bg-white font-display text-text-primary touch-pan-y">
      <div
      ...
      >
        ...
        <div className="relative flex w-full max-w-3xl flex-col items-center overflow-visible">
          <div className="mb-6 max-w-full rounded-full bg-red-500 px-6 py-3 text-center text-xl font-extrabold tracking-wide text-white shadow-sm sm:mb-10 sm:px-10 sm:py-4 sm:text-2xl md:text-3xl">
            {subject.label}
          </div>
          ...
          <button
            type="button"
            onClick={handlePrev}
            className="absolute left-1 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-slate-300 bg-slate-200/90 text-white shadow-sm transition-colors hover:bg-slate-300 sm:left-0 sm:h-12 sm:w-12 sm:-translate-x-2 md:h-14 md:w-14"
          ...
          <button
            type="button"
            onClick={handleNext}
            className="absolute right-1 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-slate-300 bg-slate-200/90 text-white shadow-sm transition-colors hover:bg-slate-300 sm:right-0 sm:h-12 sm:w-12 sm:translate-x-2 md:h-14 md:w-14"
